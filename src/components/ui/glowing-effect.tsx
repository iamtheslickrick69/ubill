...
interface GlowingEffectProps {
  ...
  proximity?: number;
  spread?: number;
  variant?: "default" | "white" | "electric-blue";
  glow?: boolean;
  className?: string;
  disabled?: boolean;
...
const GlowingEffect = memo(
  ({
    ...
    const getGradient = () => {
      ...
      if (variant === "electric-blue") {
        return `radial-gradient(circle, #60A5FA 10%, #60A5FA00 20%),
                ...
                repeating-conic-gradient(
                  ...
                  #1E40AF calc(75% / var(--repeating-conic-gradient-times)),
      ...
      <>
        <div
          className={cn(
            ...
            variant === "electric-blue" && "border-blue-400",
            disabled && "!block"
          )}
        />
        <div
